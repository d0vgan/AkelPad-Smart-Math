...
tests(134).expr = "atan2((1,2),3)":   tests(134).expected = "(0.3217505543966422,0.5880026035475675)" ' [shape]
  ...
  tests(643).expr = "x=0.0/0.0; abs(x)": tests(643).expected = "inf"
  ...
  tests(647).expr = "x=0.0/0.0; ln(x)": tests(647).expected = "inf"
  tests(648).expr = "x=1.0/0.0; ln(x)": tests(648).expected = "inf"
  tests(649).expr = "z=0.0; ln(z)": tests(649).expected = "-inf"
  tests(650).expr = "x=0.0/0.0; sqrt(x)": tests(650).expected = "inf"
  tests(651).expr = "x=1.0/0.0; sin(x)": tests(651).expected = "inf"
  ...
  tests(706).expr = "x=0.0/0.0; sum(1,x)": tests(706).expected = "inf"
  ...
  tests(769).expr = "x=-1.0/0.0; sin(x)": tests(769).expected = "inf"
  ...
  tests(782).expr = "-inf + inf": tests(782).expected = "inf"
  tests(783).expr = "inf/-inf": tests(783).expected = "inf"
  ...
  tests(787).expr = "inf-inf": tests(787).expected = "inf"
  tests(788).expr = "(-inf)/(-inf)": tests(788).expected = "inf"
