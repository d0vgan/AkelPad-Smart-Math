...
sub Main()
  dim tests(1 to 731) as SmokeCase
  ' Inline tag legend:
...
tests(134).expr = "atan2((1,2),3)":   tests(134).expected = "(0.3217505543966422,0.5880026035475675)" ' [shape]
  ...
  tests(636).expr = "x=0.0/0.0; x+0": tests(636).expected = "inf"
  ...
  tests(641).expr = "x=0.0/0.0; x+1": tests(641).expected = "inf"
  tests(642).expr = "x=-1.0/0.0; abs(x)": tests(642).expectedErrContains = "numeric error in abs()"
  tests(643).expr = "x=0.0/0.0; abs(x)": tests(643).expectedErrContains = "numeric error in abs()"
  tests(644).expr = "x=1.0/0.0; sign(x)": tests(644).expectedErrContains = "numeric error in sign()"
  tests(645).expr = "x=-1.0/0.0; sign(x)": tests(645).expectedErrContains = "numeric error in sign()"
  tests(646).expr = "x=0.0/0.0; sign(x)": tests(646).expectedErrContains = "numeric error in sign()"
  tests(647).expr = "x=0.0/0.0; ln(x)": tests(647).expectedErrContains = "numeric error in ln()"
  tests(648).expr = "x=1.0/0.0; ln(x)": tests(648).expectedErrContains = "numeric error in ln()"
  tests(649).expr = "z=0.0; ln(z)": tests(649).expected = "-inf"
  tests(650).expr = "x=0.0/0.0; sqrt(x)": tests(650).expectedErrContains = "numeric error in sqrt()"
  tests(651).expr = "x=1.0/0.0; sin(x)": tests(651).expectedErrContains = "numeric error in sin()"
  tests(652).expr = "x=1.0/0.0; frac(x)": tests(652).expectedErrContains = "numeric error in frac()"
  ...
  tests(690).expr = "x=0.0/0.0; hex(x)": tests(690).expected = "inf"
  ...
  tests(704).expr = "x=1.0/0.0; sqrt(x)": tests(704).expectedErrContains = "numeric error in sqrt()"
  tests(705).expr = "a=(0.0/0.0,1.0/0.0,-1.0/0.0); a": tests(705).expected = "(inf,inf,-inf)"
  tests(706).expr = "x=0.0/0.0; sum(1,x)": tests(706).expectedErrContains = "numeric error in sum()"
